...
import { WhatsappIcon, WhatsappButton, StickyCTA } from "@/components/whatsapp-button";
...
const faqJsonLd = {
  ...
  "@graph": [
    {
      "@type": "LegalService",
      "@id": "https://petriaazevedo.com.br/#service",
      ...
      url: "https://petriaazevedo.com.br/",
      telephone: "+55-27-3208-2264",
      email: "contato@petriaazevedo.com.br",
      areaServed: { "@type": "Country", name: "Brasil" },
      provider: { "@id": "https://petriaazevedo.com.br/#attorney" },
      aggregateRating: {
    ...
    {
      "@type": "Attorney",
      "@id": "https://petriaazevedo.com.br/#attorney",
      ...
      knowsLanguage: ["pt-BR"],
      worksFor: { "@id": "https://petriaazevedo.com.br/#service" },
    },
    {
      "@type": "AggregateRating",
      "@id": "https://petriaazevedo.com.br/#rating",
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "Início",
          item: "https://petriaazevedo.com.br/",
        },
        {
          "@type": "ListItem",
          position: 2,
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:url",
        content: "https://petriaazevedo.com.br/",
      },
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-NKTFFTK31T",
      },
      {
        children: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-NKTFFTK31T');`,
      },
      {
    ...
    <section className="relative lg:hidden">
      ...
      <div className="relative overflow-hidden bg-[var(--color-bordeaux-deep)] text-[var(--color-cream)]">
        ...
        <div className="relative px-5 pb-10 pt-8">
          ...
          {/* CTA */}
          <div className="mt-7">
            <WhatsappButton origin="hero-mobile" size="lg" fullWidth label="Fale com advogado agora mesmo" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-16 px-8 py-28 lg:grid-cols-12">
        <div className="lg:col-span-7">
          ...
          <div className="mt-9 flex flex-row items-center gap-5">
            <WhatsappButton origin="hero" size="xl" label="Fale com advogado agora mesmo" />
    ...
    <section id="como-funciona" className="scroll-mt-16 bg-background py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div className="mt-12 flex flex-col items-center gap-3">
          <WhatsappButton origin="how-it-works" label="Fale com advogado agora mesmo" />
      ...
      <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <div className="mt-12 grid gap-10 lg:mt-14 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-14">
          ...
          <div>
            ...
            <div className="mt-9">
              <WhatsappButton origin="authority" label="Fale com advogado agora mesmo" />
            </div>
          </div>
        </div>
    ...
    <section id="faq" className="scroll-mt-16 bg-background py-16 sm:py-24">
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        ...
        <div className="mt-12 flex justify-center">
          <WhatsappButton origin="faq" label="Fale com advogado agora mesmo" />
        </div>
      </div>
    </section>
  );
